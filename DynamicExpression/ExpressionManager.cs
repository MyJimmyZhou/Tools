...
namespace DynamicExpression
{
    public class ExpressionManager
    {
        ...
        public static Expression<Func<T, bool>> ExpressionConvert<T>(Expression<Func<T, bool>> func1)
        {
            var parameters = func1.Parameters;
            List<ExpressionModel> modelList = new List<ExpressionModel>();
            SplitExpressions<T>(func1.Body, parameters, modelList);
